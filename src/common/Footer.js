...
const Footer = () => {
  return (
    <footer className="bottom-0 left-0 z-20 w-full p-4 border-t border-gray-500 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
